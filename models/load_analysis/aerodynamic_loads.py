...
class AerodynamicLoads(AerostructuralLoad):
    ...
    def setup(self):
        ...
        self.add_input("data:loads:max_shear:cg_position", val=np.nan)
        self.add_input("data:loads:max_shear:mass", val=np.nan)
        self.add_input("data:loads:max_rbm:load_factor", val=np.nan)
        self.add_input("data:loads:max_rbm:cg_position", val=np.nan)
        self.add_input("data:loads:max_rbm:mass", val=np.nan)
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        y_vector, _ = self.compute_relief_force(inputs, y_vector_orig, chord_vector, 0., 0., False)
