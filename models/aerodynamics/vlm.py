...
class VLM(ExternalCodeComp):
    ...
    def compute_wing(self, inputs, AOAList, flaps_angle=0.0, use_airfoil=True):
        ...
        Vinf = inputs['data:TLAR:cruise_speed']*0.514444 # conversion to m/s
    ...
    def compute_htp(self, inputs, AOAList):
